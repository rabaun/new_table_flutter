          ...
          itemBuilder: (context, index) {
            return Column(
              children: [
                ...
                _buildListItem('Название организации', microclimate?[index].organizationName),
                ...
                _buildListItem('Место работы', microclimate?[index].workplace),
                ...
                _buildListItem('Температура воздуха на высоте 0,1м', microclimate?[index].airTemperature01m),
                _buildListItem('Температура воздуха на высоте 1,5м', microclimate?[index].airTemperature15m),
                ...
                _buildListItem('Значение скорости воздушного потока на высоте 0,1м', microclimate?[index].airVelocity01m),
                _buildListItem('Значение скорости воздушного потока на высоте 1,5м', microclimate?[index].airVelocity15m),
