...
GeneralVibrationProtocolModel _$GeneralVibrationProtocolModelFromJson(
    Map<String, dynamic> json) {
  return _GeneralVibrationProtocolModel.fromJson(json);
}

/// @nodoc
mixin _$GeneralVibrationProtocolModel {
  ...
  $GeneralVibrationProtocolModelCopyWith<GeneralVibrationProtocolModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GeneralVibrationProtocolModelCopyWith<$Res> {
  factory $GeneralVibrationProtocolModelCopyWith(
          GeneralVibrationProtocolModel value,
          $Res Function(GeneralVibrationProtocolModel) then) =
      _$GeneralVibrationProtocolModelCopyWithImpl<$Res,
          GeneralVibrationProtocolModel>;
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class _$GeneralVibrationProtocolModelCopyWithImpl<$Res,
        $Val extends GeneralVibrationProtocolModel>
    implements $GeneralVibrationProtocolModelCopyWith<$Res> {
  _$GeneralVibrationProtocolModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GeneralVibrationProtocolModelImplCopyWith<$Res>
    implements $GeneralVibrationProtocolModelCopyWith<$Res> {
  factory _$$GeneralVibrationProtocolModelImplCopyWith(
          _$GeneralVibrationProtocolModelImpl value,
          $Res Function(_$GeneralVibrationProtocolModelImpl) then) =
      __$$GeneralVibrationProtocolModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$GeneralVibrationProtocolModelImplCopyWithImpl<$Res>
    extends _$GeneralVibrationProtocolModelCopyWithImpl<$Res,
        _$GeneralVibrationProtocolModelImpl>
    implements _$$GeneralVibrationProtocolModelImplCopyWith<$Res> {
  __$$GeneralVibrationProtocolModelImplCopyWithImpl(
      _$GeneralVibrationProtocolModelImpl _value,
      $Res Function(_$GeneralVibrationProtocolModelImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$GeneralVibrationProtocolModelImpl
    implements _GeneralVibrationProtocolModel {
  const _$GeneralVibrationProtocolModelImpl(
      {this.id,
  ...
  factory _$GeneralVibrationProtocolModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GeneralVibrationProtocolModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GeneralVibrationProtocolModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GeneralVibrationProtocolModelImplCopyWith<
          _$GeneralVibrationProtocolModelImpl>
      get copyWith => __$$GeneralVibrationProtocolModelImplCopyWithImpl<
          _$GeneralVibrationProtocolModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GeneralVibrationProtocolModelImplToJson(
      this,
    );
  }
}
