...
class _AddProtocolNameDialogState extends State<AddWorkplaceDialog> {
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<WorkplaceBloc>(context)
        .add(WorkplaceEvent.getOrganization(organization: widget.organization));
    organizationNameController.text =
        (widget.workplace?.organizationName ?? widget.organization?.organizationName)!;
    organizationIdController.text =
        (widget.workplace?.organizationId ?? widget.organization?.organizationId)!;
