              ...
              children: [
                ...
                pw.Table(
                  ...
                  children: [
                    ...
                    // Данные протокола
                    for (var protocol in primaryProtocolList ?? []) ...[
                      pw.TableRow(children: [
                      ...
                      pw.TableRow(children: [
                        _buildTableCell('Значение уровня шума №1:', ttf),
                        _buildValueCell(protocol.parameterValue1, ttf),
                      ]),
                      pw.TableRow(children: [
                        _buildTableCell('Значение уровня шума №2:', ttf),
                        _buildValueCell(protocol.parameterValue2, ttf),
                      ]),
                      pw.TableRow(children: [
                        _buildTableCell('Значение уровня шума №3:', ttf),
                        _buildValueCell(protocol.parameterValue3, ttf),
                      ]),
                      pw.TableRow(children: [
                        _buildTableCell('Среднее значение уровня шума:', ttf),
